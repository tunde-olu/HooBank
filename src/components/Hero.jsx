...
const Hero = () => {
    return (
        <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart, styles.paddingX} flex-col xl:flex-row`}>
                ...
                <div className='flex flex-row justify-between items-center w-full'>
                    <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>Then Next <br className='sm:hidden' /> <span className='text-gradient'>Generation </span></h1>
